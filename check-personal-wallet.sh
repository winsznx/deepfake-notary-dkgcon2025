...
WALLET="0xEfd50EC809f87393b87513f207DaddEb80C0491F"
RPC="https://lofar-testnet.origin-trail.network"

echo "🔍 Checking personal wallet balance..."
echo "📍 Wallet: $WALLET"
echo ""
...
if [ -n "$BALANCE_HEX" ]; then
  ...
  if (( $(echo "$BALANCE > 5" | bc -l) )); then
    ...
    echo "💡 You can transfer some to backend wallet: 0x10Cd8De4017fF6213d93ffF440c8c7e310117D1f"
  else
